...
import fr.eni.demo.bo.Classe;
import fr.eni.demo.bo.Eleve;
import fr.eni.demo.bo.Personne;
import fr.eni.demo.bo.Professeur;
...
public class TestBo {
	...
	public static void main(String[] args) {
		...
		e1.setNom("Dupont");
		e1.setPrenom("Alain");
		e1.setAdresse("10 allée des Lilas");
		System.out.println("e1 : "+e1);
		
		//instanciation d'un eleve de type Eleve avec le constructeur surcharg�
		Eleve e2 = new Eleve("Dupont", "Eric", "20 allée des Roses", new Classe("CP"));
		...
		Personne p1 = new Professeur("Valjean", "Jean", "10 allee des pensées", "philosophie");
		...
		if (e1.equals(e4)) {
			...
			System.out.println("instances différentes");
		}
		System.out.println("************");
		if (e1.equals(e2)) {
			System.out.println("instances identiques");
